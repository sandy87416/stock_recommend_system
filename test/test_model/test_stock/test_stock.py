...
class TestStock(TestCase):
    ...
    def test_create_stock_after_hours_information(self):
        ...
        self.assertEqual(stock_after_hours_information.get_date(), '2022-04-18')
        self.assertEqual(stock_after_hours_information.get_k_value(), -2.0)
        self.assertEqual(stock_after_hours_information.get_ma20_value(), 81.41)
        self.assertEqual(stock_after_hours_information.get_rsi_value(), 54.0)
        self.assertEqual(stock_after_hours_information.get_foreign_buy(), 137000.0)
        self.assertEqual(stock_after_hours_information.get_investment_trust_buy(), 16000.0)
        self.assertEqual(stock_after_hours_information.get_self_buy(), 10000.0)
        self.assertEqual(stock_after_hours_information.get_news(), '')
        self.assertEqual(stock_after_hours_information.get_monthly_revenue(), 5718985)

        stock_after_hours_information = self.stock.create_stock_after_hours_information(1605)
        self.assertEqual(stock_after_hours_information.get_date(), '2022-04-18')
